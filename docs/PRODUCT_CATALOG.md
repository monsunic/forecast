...
Last updated: **2026-07-26 05:36 UTC**
...
| `current` | `seacurrent` | Surface Sea Current and Direction | hycom | contourf | quiver (overlay) | `nusawave_current` (Nusawave) | 0–400 (13 bins) | cm/s | not deployed |
| `sss` | `seasalt` | Surface Sea Salinity | hycom | contourf | none | `nusawave_salinity` (Nusawave) | 30–36 (13 bins) | PSU | not deployed |
| `sst` | `seatemp` | Surface Sea Temperature | hycom | contourf | none | `nusawave_sst` (Nusawave) | 16–36 (20 bins) | degC | not deployed |
